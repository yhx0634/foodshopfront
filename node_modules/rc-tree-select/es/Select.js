...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onSelect = function (selectedKeys, info) {
    ...
    if (checkEvt) {
      extraInfo.checked = info.checked;
            extraInfo.allCheckedNodes = props.treeCheckStrictly || _this7.state.inputValue ? info.checkedNodes : flatToHierarchy(info.checkedNodesPositions);
  ...
  this.onDeselect = function (info) {
    _this7.removeSelected(getValuePropValue(info.node));
    if (!isMultipleOrTags(_this7.props)) {
      _this7.setOpenState(false);
    }
